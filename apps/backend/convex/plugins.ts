  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      await ctx.db.patch(existing._id, {
        ...
        ...(args.policyFingerprint ? { policyFingerprint: args.policyFingerprint } : {}),
        ...(args.riskProfile ? { riskProfile: args.riskProfile } : {}),
        ...(args.toolContracts ? { toolContracts: args.toolContracts } : {}),
